      ...
      render(rowData: any, rowIndex) {
        return (
          <n-input-number
            ...
            value={rowData.properties.height}
            onUpdateValue={(value: number) => {
              BlockFeauresManager.onChangeFillHeight(
                rowData.properties.index,
                value
              );
            }}
        ...
        return (
          <NColorPicker
            ...
            onUpdateValue={(value: string) => {
              BlockFeauresManager.onChangeColor(
                rowData.properties.index,
                value
              );
            }}
  ...
  <div class="ground-layer-container">
    <NCard title="Draw Block" size="small">
      ...
      <NFormItem label="Fill Color:" label-placement="left">
        <NColorPicker
          v-model:value="DrawBlockHook.state.properties.color"
          :show-alpha="false"
        />
      </NFormItem>
      ...
      <NSpace>
        ...
        >
        <NButton
          v-if="DrawBlockHook.state.drawing"
          @click="DrawBlockHook.cancelDraw"
          >Cancel</NButton
        >
      </NSpace>
    </NCard>
